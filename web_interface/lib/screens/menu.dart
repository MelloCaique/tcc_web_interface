...
import 'package:web_interface/services/venda.dart';
...
class _MenuState extends State<Menu> {
  ...
  static List<Widget> tabWidgetsConsultorio = <Widget>[Receitas(), Cadastro()];
  static List<Widget> tabWidgetsFarmacia = <Widget>[Receitas(), Venda()];
        ...
        body: Container(
          child: Center(
            ...
            children: [
                            ...
                            children: <Widget>[
                              Flexible(
                                ...
                                child: GestureDetector(
                                  child:
                                      ReceitasButtom("Amarela", Colors.yellow),
                                  onTap: () {
                                    // botão receituário amarelo
                                  },
                                ),
                              ),
                              SizedBox(
              ...
              Flexible(
                  flex: 8,
                  child: (instituicao == "Consultório A")
                      ? tabWidgetsConsultorio.elementAt(_selectedIndex)
                      : tabWidgetsFarmacia.elementAt(_selectedIndex))
            ],
          )),
        ),
        bottomNavigationBar: (instituicao == "Consultório A")
            ...
            BottomNavigationBar(
                ...
                items: const <BottomNavigationBarItem>[
                  ...
                  BottomNavigationBarItem(
                      icon: Icon(Icons.attach_money), label: "Venda")
                ],
                currentIndex: _selectedIndex,
                onTap: (index) {
                  setState(() {
